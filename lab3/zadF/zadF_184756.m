...
for x = 1:size(Ns,2)
    ...
    name = sprintf("zadF/zadF_184756_%d",x);
...
title("Czasy rozwiązywania układów równań metodą Gaussa-Seidla w funkcji N")
print("zadF/zadF_184756_czas",'-dpng','-r300')

% Wykres liczby iteracji
figure(size(Ns,2)+1)
plot(Ns,tries)
xlabel("N - liczba stron")
ylabel("Liczba iteracji algorytmu Gaussa-Seidla")
title("Liczba iteracji potrzebna do rozwiązania metodą Gaussa-Seidla")
print("zadF/zadF_184756_iteracje",'-dpng','-r300')